// ============================================================
// src/Video12_RentVsBuy20.tsx
// "Renting vs buying, twenty years out" — same assumptions and
// mechanic as Video14_RentVsBuy.tsx (two vertical bars growing
// upward over a shared time axis, reusing Kick, Hook, Punchline
// and the racing-bar mechanic from Video09_SnowballAvalanche.tsx),
// just extended from a 10-year to a 20-year axis with new end
// values. Same safe-area/COLORS pattern as the other Video files.
// ============================================================
...
const TOTAL_MONTHS = 240; // 20 years
...
export const Video12_RentVsBuy20: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  const year = Math.min(Math.round(monthsElapsed / 12), 20);
      ...
      >
        ...
        <Hook
          ...
          beats={[
            ...
            { fromFrame: 110, line1: "Twenty years", line2: "out." },
          ]}
        />
        ...
        >
          ...
          rent &middot; 3.5% appreciation &middot; 7% invested
        </div>
...
export const VIDEO12_RENT_VS_BUY_20_DURATION_IN_FRAMES = Math.round(
